        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                    ...
                    <label>Ảnh Loai Phong</label><br>
                        <img id="previewImg2" src="img/default.png">
                    </div>
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" name="AnhLoaiPhong" accept="image/*" onchange="previewImage2()" id="file2" class="custom-file-input" aria-describedby="inputGroupFileAddon01">
                            <label class="custom-file-label" for="inputGroupFile01">Chọn file</label>
                        </div>   
                    </div>
            <div class="form-group">
