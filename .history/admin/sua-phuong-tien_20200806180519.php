                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" name="HinhAnh" class="custom-file-input" onchange="previewImage();" aria-describedby="inputGroupFileAddon01">
                    ...
                    <div class="form-group">
                    <img id="preview">
                    <input type="file" name="HinhAnh" id="file" onchange="previewImage()">
                    </div>
