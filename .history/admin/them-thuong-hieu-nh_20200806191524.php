    ...
    <div class="card shadow mb-4">
        ...
        <form action="code.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label> Mô Tả </label>
                    <textarea rows="5"  name="MoTa" class="form-control" placeholder="Nhập Mô Tả"></textarea>
                </div>
                <div class="form-group">
                    <label>Ảnh </label><br>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="btn_them_thuong_hieu_nh" class="btn btn-primary">Lưu</button>
            </div>
