  ...
  <div class="card-body">
    <?php
        if(isset($_POST['edit_btn']))
        {
            ...
            {
    ?>
                <form action="code.php" method="POST" id="UploadForm" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <div class="col-md-6"><input type="file" name="HinhAnh" accept="image/*" onchange="previewImage()" id="file" class="custom-file-input" aria-describedby="inputGroupFileAddon01"></div>
                    <div class="col-md-6"><img id="previewImg" src="img/phuong-tien/<?php echo $row['HinhAnh']; ?>"></div>
                    </div>
