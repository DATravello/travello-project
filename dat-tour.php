...
<head>
    ...
    <!-- JQuery Step Plugins -->
    <link rel="stylesheet" href="plugins/step-jquery/css/jquery.steps.css">
    <link rel="stylesheet" href="plugins/step-jquery/css/main.css">
    <script src="js/jquery-3.5.1.min.js"></script>
    <script src="plugins/step-jquery/js/jquery.steps.js"></script>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><?php echo $r_kh["Email"] ?></a>
                    </li>
                </ul>
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
    ...
    <div class="container tour-book content">
        <div class="row">
            <!-- LEFT CONTENT -->
