                ...
                <tr>
                  ...
                  <td>
                    <form action="code.php" method="post">
                      <input type="hidden" name="xoa_khachhang" value="<?php echo $row['MaKH']; ?>">
                      <button type="submit" name="btn_xoa_khachhang" class="btn btn-danger"><i class="fas fa-ban"></i></button> 
                    </form>
                  </td>
                </tr>
          <?php
