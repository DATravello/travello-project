  ...
  <div class="card-body">
    ...
    ?>
                <form action="code.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label> Mô Tả </label>
                        <textarea rows="5" name="sua_mota"  value="<?php echo $row['MoTa'] ?>" class="form-control" placeholder="Nhập Mô Tả"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" name="btn_capnhat_thuonghieu_ks" class="btn btn-primary">Lưu</button>
                </form>
