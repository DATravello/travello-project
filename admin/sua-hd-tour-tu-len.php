                ...
                <form action="code.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="sua_tinhtrang">
                            <option <?php if (isset($pay) && $pay == 'Đã Xác Nhận') echo "selected=\"selected\"";  ?> value="Đã Xác Nhận">Chưa Xác Nhận</option>
                            ...
                            <option <?php if (isset($pay) && $pay == 'Đã Huỷ') echo "selected=\"selected\"";  ?> value="Đã Huỷ">Đã Huỷ</option>
                        </select><br /><br />
                    </div>
